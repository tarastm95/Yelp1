...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('webhooks', '0070_autoresponsesettings_sms_on_customer_reply_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(condition=models.Q(('business__isnull', False)), fields=('business',), name='uniq_greeting_per_business')],
            },
        ),
    ]
